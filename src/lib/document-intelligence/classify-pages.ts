...
const CLASSIFIERS: ClassifierRule[] = [
  ...
  { type: "agent_producer_disclosure", patterns: [/insurance agent|producer disclosure/i, /agent disclosure/i], weight: 3 },
  { type: "acknowledgments_signatures", patterns: [/acknowledgments and signatures/i, /applicant acknowledgment/i], weight: 3 },
